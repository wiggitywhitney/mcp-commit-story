...
- **Signal-based workflow:** Git commits create signal files containing commit information. When you want a journal entry, you ask your AI assistant to "create a journal entry" and it processes all pending signals.
- **Rich context collection:** The MCP server works with AI agents to pull in commit messages, code changes, terminal commands, and AI chat history, building a rich, evidence-based journal entry.
...
## Signal-Based Design: Capture Now, Process When Ready

MCP Commit Story uses a git hook to capture the context of your work at commit time by creating lightweight signal files. When you're ready to reflect on your progress, simply ask your AI assistant to "create a journal entry" and it will process all accumulated signals to generate rich journal entries, daily summaries, and other insights. This approach captures the timing and context of your work without interrupting your flow, while giving you control over when the AI processing happens.
